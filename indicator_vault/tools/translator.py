...
def build_translation_prompt(slug_name: str, pine_code: str) -> str:
    return (
        "Convert the following Pine Script v5 code into Python following all rules exactly.\n"
        f"Indicator name: {slug_name}\n\n"
        "PINE SCRIPT:\n"
        f"{pine_code}"
    )
